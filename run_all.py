...
from services.matricula import app as matricula_app
...
if __name__ == "__main__":
    threads = [
        ...
        threading.Thread(target=run, args=(matricula_app, 8003), daemon=True),      #MATRICULA
    ...
    print("Services up: academico:8010, disciplina:8000, aluno:8001, notas:8002, matricula:8003, turmas:8004, professor:8005")
    try:
        while True:
            time.sleep(1)
